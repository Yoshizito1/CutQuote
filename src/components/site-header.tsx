  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border bg-background/85 backdrop-blur">
      <div className="mx-auto flex max-w-[1600px] items-center gap-4 px-4 py-3">
        {/*
          A logo é servida como <img> com currentColor no SVG, então acompanha
          o tema claro/escuro sem precisar de dois arquivos. `text-foreground`
          define a cor que o SVG herda.
        */}
        <a
          href="/"
          className="flex shrink-0 items-center text-foreground"
          aria-label="BELLARI corte e dobra — página inicial"
        >
          <img
            src="/marca/bellari.svg"
            alt="BELLARI corte&dobra"
            width={140}
            height={56}
